...
// Read hol_lesson_progress for lesson completion badges
...
// ── Feature 2: lesson completion badge ────────────────────────────
const trackKey    = `job_${job.id}`
const lessonCount = Object.keys(lessonProgress).filter(k => k.startsWith(trackKey + '_')).length
...
{/* Lesson completion badge (Feature 2) */}
{lessonCount > 0 && !graduated && (
<span style={{
fontSize: '0.7rem',
background: 'rgba(99,102,241,0.25)',
color: 'rgba(167,168,255,0.95)',
